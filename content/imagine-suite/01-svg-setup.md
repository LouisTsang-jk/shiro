...
SVG 技术规范,在 `diagram` 和 `art` 两个模块中都会出现。
...
Here's a CSV table to give you a better sense of the Anthropic Sans font rendering width:
