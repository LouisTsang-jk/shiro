# 04 — Charts and Geographic Maps

由 `read_me modules=["chart"]` 触发。Chart.js + D3 choropleth。

## Charts (Chart.js)

```html
<div style="position: relative; width: 100%; height: 300px;">
  <canvas id="myChart" role="img" aria-label="Bar chart of quarterly revenue, Q1 through Q4">
...
**Dashboard layout** — wrap summary numbers in metric cards (see UI components) above the chart. Chart canvas flows below without a card wrapper. Use `sendPrompt()` for drill-down: `sendPrompt('Break down Q4 by region')`.
